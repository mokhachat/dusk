...
func (rcv *Scene) Animes(obj *Anim, j int) bool {
...
func (rcv *Scene) AnimesLength() int {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(6))
	if o != 0 {
		return rcv._tab.VectorLen(o)
	}
...
func SceneStart(builder *flatbuffers.Builder) { builder.StartObject(2) }
...
func SceneAddAnimes(builder *flatbuffers.Builder, animes flatbuffers.UOffsetT) { builder.PrependUOffsetTSlot(1, flatbuffers.UOffsetT(animes), 0) }
func SceneStartAnimesVector(builder *flatbuffers.Builder, numElems int) flatbuffers.UOffsetT { return builder.StartVector(4, numElems, 4)
}
